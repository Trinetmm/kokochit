	...
	<div id="wrapper">
			<div id="page-wrapper">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6{{ $errors->has('photos') ? ' has-error' : '' }}">
						<label class="control-label" for="photo">Photo</label>
						@if($errors->has('photos'))
							<label class="control-label" for="quantity">({{ $errors->first('photos') }})</label>
						@endif
						<input type="file" id="photo" name="photos[]" multiple>
						<p class="help-block">Hello Hello</p>
					</div>
